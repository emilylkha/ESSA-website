  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <section className="w-full max-w-5xl text-center p-10">
        <h1 className="text-4xl font-bold text-green-800 mb-4">Welcome to the Economics Student Society of Australia</h1>
        ...
        <div className="my-12">
          <h2 className="text-3xl font-semibold text-green-800 mb-4">Upcoming Events</h2>
